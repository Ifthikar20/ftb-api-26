...
class LeadSerializer(serializers.ModelSerializer):
    ...
    # 'location' is the field the frontend template uses; map it from geo_country
    location = serializers.CharField(source="visitor.geo_country", read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            "visitor_fingerprint", "geo_country", "location", "device_type",
