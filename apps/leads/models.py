...
# Email-campaign feature retired in favour of LLM Ranking + GEO.
# EmailCampaign and CampaignRecipient models removed; the corresponding
# tables are dropped by apps.accounts.migrations.0010_drop_campaign_tables.
