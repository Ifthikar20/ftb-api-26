...
urlpatterns = [
    ...
    path(
        "prompts/generate-related/",
        views.PromptGenerateRelatedView.as_view(),
        name="prompt-library-generate-related",
    ),
    path(
    ...
    path(
        "websites/<uuid:website_id>/prompts/<uuid:prompt_id>/schedule/",
        views.PromptScheduleView.as_view(),
